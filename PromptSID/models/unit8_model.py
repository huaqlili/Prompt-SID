...
class MYModel(SRModel):
    ...
    def feed_data(self, data):
        ...
        noise_adder = AugmentNoise(style="gauss30")
        ...
        if self.is_train:
            self.lq = noise_adder.add_train_noise(self.lq)
            self.lq0 = self.lq
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(MYModel, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
