...
if __name__ == "__main__":
    img = torch.randn((2, 3, 64, 64)).to('cuda')
    mask1, mask2, mask3 = generate_mask_pair(img)

    noisy_sub1 = generate_subimages(img, mask1).to('cuda')
    noisy_sub2 = generate_subimages(img, mask2).to('cuda')
    noisy_sub3 = generate_subimages(img, mask2).to('cuda')
    print(noisy_sub1.shape)
    print(noisy_sub2.shape)
    print(noisy_sub3.shape) 